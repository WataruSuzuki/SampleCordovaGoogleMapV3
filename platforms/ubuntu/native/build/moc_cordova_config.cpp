...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CordovaInternal__Config_t, stringdata0) + ofs \
...
void *CordovaInternal::Config::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CordovaInternal__Config.stringdata0))
